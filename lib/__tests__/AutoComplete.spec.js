...
describe('AutoComplete', function () {
  ...
  it('renders an AutoComplete', function () {
    ...
    }).render()).toEqualJSX(_react2.default.createElement(_AutoComplete2.default, { dataSource: dataSource, name: 'myAutoComplete', searchText: 'Foo', onChange: _lodash2.default, ref: 'component' }));
  });
  ...
  it('renders an AutoComplete with an error', function () {
    (0, _expect2.default)(new _AutoComplete4.default({
      ...
      error: 'FooError',
      touched: true
    }).render()).toEqualJSX(_react2.default.createElement(_AutoComplete2.default, { dataSource: dataSource, name: 'myAutoComplete', searchText: 'Foo', errorText: 'FooError', onChange: _lodash2.default,
      ref: 'component' }));
  });
  ...
  it('maps onChange properly', function () {
    ...
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      ...
      _react2.default.createElement(_AutoComplete4.default, { dataSource: dataSource, name: 'myAutoComplete', input: { onChange: onChange, value: 'Foo' } })
    ));
  ...
  it('provides getRenderedComponent', function () {
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      _MuiThemeProvider2.default,
      { muiTheme: (0, _getMuiTheme2.default)() },
      _react2.default.createElement(_AutoComplete4.default, { dataSource: dataSource, input: { name: 'myAutoComplete' } })
    ));
