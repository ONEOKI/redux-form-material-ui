...
describe('RadioButtonGroup', function () {
  ...
  it('renders a RadioButtonGroup', function () {
    ...
    }).render()).toEqualJSX(_react2.default.createElement(_RadioButton.RadioButtonGroup, { name: 'myRadio', value: 'Foo', ref: 'component' }));
  });
  ...
  it('renders a RadioButtonGroup with an error', function () {
    (0, _expect2.default)(new _RadioButtonGroup2.default({
      ...
      error: 'FooError',
      touched: true
    }).render()).toEqualJSX(_react2.default.createElement(_RadioButton.RadioButtonGroup, { name: 'myRadio', value: 'Foo', errorText: 'FooError',
      ref: 'component' }));
  });
